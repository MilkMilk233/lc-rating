...
export default{
    ...
    "nonLeafChild": [
                        ...
                        },
                        {
                            ...
                            "leafChild": [
                                ...
                                },
                                {
                                    ...
                                    "summary": "",
                                    "src": "/sort-the-matrix-diagonally/",
                                    "original_src": "https://leetcode.cn/problems/sort-the-matrix-diagonally/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": 1548.4678056182,
                                    "leafChild": [],
                                    "nonLeafChild": [],
                                    "isPremium": false,
                                    "last_update": ""
                                },
                                {
                                    "title": "498. 对角线遍历",
                                    "summary": "",
                                    "src": "/diagonal-traverse/",
                                    "original_src": "https://leetcode.cn/problems/diagonal-traverse/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
                                ...
                                },
                                {
                                    ...
                                    "summary": "",
                                    "src": "/max-black-square-lcci/",
                                    "original_src": "https://leetcode.cn/problems/max-black-square-lcci/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
                        ...
                        },
                        {
                            ...
                            "leafChild": [
                                ...
                                },
                                {
                                    ...
                                    "summary": "",
                                    "src": "/stable-subarrays-with-equal-boundary-and-interior-sum/",
                                    "original_src": "https://leetcode.cn/problems/stable-subarrays-with-equal-boundary-and-interior-sum/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": 1908.8920524591,
                                    "leafChild": [],
                                    "nonLeafChild": [],
                                    "isPremium": false,
                                    "last_update": ""
                            ...
                            "nonLeafChild": [
                                {
                                    ...
                                    "leafChild": [
                                        ...
                                        },
                                        {
                                            ...
                                            "summary": "",
                                            "src": "/living-people-lcci/",
                                            "original_src": "https://leetcode.cn/problems/living-people-lcci/",
                                            "sort": 0,
                                            "isLeaf": true,
                                            "solution": null,
                                            "score": null,
                        ...
                        },
                        {
                            ...
                            "leafChild": [
                                ...
                                },
                                {
                                    "title": "1500. 设计文件分享系统",
                                    "summary": "",
                                    "src": "/design-a-file-sharing-system/",
                                    "original_src": "https://leetcode.cn/problems/design-a-file-sharing-system/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
                                ...
                                {
                                    "title": "3506. 查找消除细菌菌株所需时间",
                                    "summary": "",
                                    "src": "/find-time-required-to-eliminate-bacterial-strains/",
                                    "original_src": "https://leetcode.cn/problems/find-time-required-to-eliminate-bacterial-strains/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
                                ...
                                },
                                {
                                    "title": "1912. 设计电影租借系统",
                                    "summary": "",
                                    "src": "/design-movie-rental-system/",
                                    "original_src": "https://leetcode.cn/problems/design-movie-rental-system/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": 2181.7821188042,
                                    "leafChild": [],
                                    "nonLeafChild": [],
                                    "isPremium": false,
                                    "last_update": ""
        ...
        },
        {
            ...
            "leafChild": [
                ...
                },
                {
                    ...
                    "summary": "",
                    "src": "/longest-balanced-subarray-ii/",
                    "original_src": "https://leetcode.cn/problems/longest-balanced-subarray-ii/",
                    "sort": 0,
                    "isLeaf": true,
                    "solution": null,
                    "score": 2723.5212649775,
                    "leafChild": [],
                    "nonLeafChild": [],
                    "isPremium": false,
                    "last_update": ""
        ...
        {
            "title": "使用方法举例",
            "summary": "nums = [3, 1, 4, 1, 5, 9, 2, 6]<br>st = SparseTable(nums, max)<br>print(st.query(0, 5))  # max(nums[0:5]) = 5<br>print(st.query(1, 1))  # 错误：必须保证 l < r<br>```<br>```java [sol-Java]<br>class SparseTable {<br>private final int[][] stMin;<br>private final int[][] stMax;<br>// 时间复杂度 O(n * log n)<br>public SparseTable(int[] nums) {<br>int n = nums.length;<br>int w = 32 - Integer.numberOfLeadingZeros(n);<br>stMin = new int[w][n];<br>stMax = new int[w][n];<br>for (int j = 0; j < n; j++) {<br>stMin[0][j] = nums[j];<br>stMax[0][j] = nums[j];<br>}<br>for (int i = 1; i < w; i++) {<br>for (int j = 0; j + (1 << i) <= n; j++) {<br>stMin[i][j] = Math.min(stMin[i - 1][j], stMin[i - 1][j + (1 << (i - 1))]);<br>stMax[i][j] = Math.max(stMax[i - 1][j], stMax[i - 1][j + (1 << (i - 1))]);<br>}<br>}<br>}<br>// [l, r) 左闭右开，下标从 0 开始<br>// 必须保证 l < r<br>// 时间复杂度 O(1)<br>public int queryMin(int l, int r) {<br>int k = 31 - Integer.numberOfLeadingZeros(r - l);<br>return Math.min(stMin[k][l], stMin[k][r - (1 << k)]);<br>}<br>// [l, r) 左闭右开，下标从 0 开始<br>// 必须保证 l < r<br>// 时间复杂度 O(1)<br>public int queryMax(int l, int r) {<br>int k = 31 - Integer.numberOfLeadingZeros(r - l);<br>return Math.max(stMax[k][l], stMax[k][r - (1 << k)]);<br>}<br>}<br>```<br>```cpp [sol-C++]<br>class SparseTable {<br>vector<vector<int>> st_min;<br>vector<vector<int>> st_max;<br>public:<br>// 时间复杂度 O(n * log n)<br>SparseTable(const vector<int>& nums) {<br>size_t n = nums.size();<br>int w = bit_width(n);<br>st_min.resize(w, vector<int>(n));<br>st_max.resize(w, vector<int>(n));<br>for (int j = 0; j < n; j++) {<br>st_min[0][j] = nums[j];<br>st_max[0][j] = nums[j];<br>}<br>for (int i = 1; i < w; i++) {<br>for (int j = 0; j + (1 << i) <= n; j++) {<br>st_min[i][j] = min(st_min[i - 1][j], st_min[i - 1][j + (1 << (i - 1))]);<br>st_max[i][j] = max(st_max[i - 1][j], st_max[i - 1][j + (1 << (i - 1))]);<br>}<br>}<br>}<br>// [l, r) 左闭右开，下标从 0 开始<br>// 必须保证 l < r<br>// 时间复杂度 O(1)<br>int query_min(int l, int r) const {<br>int k = bit_width((uint32_t) r - l) - 1;<br>return min(st_min[k][l], st_min[k][r - (1 << k)]);<br>}<br>// [l, r) 左闭右开，下标从 0 开始<br>// 必须保证 l < r<br>// 时间复杂度 O(1)<br>int query_max(int l, int r) const {<br>int k = bit_width((uint32_t) r - l) - 1;<br>return max(st_max[k][l], st_max[k][r - (1 << k)]);<br>}<br>};<br>```<br>```go [sol-Go]<br>type sparseTable[T any] struct {<br>st [][]T<br>op func(T, T) T<br>}<br>// 时间复杂度 O(n * log n)<br>func newSparseTable[T any](nums []T, op func(T, T) T) sparseTable[T] {<br>n := len(nums)<br>w := bits.Len(uint(n))<br>st := make([][]T, w)<br>for i := range st {<br>st[i] = make([]T, n)<br>}<br>copy(st[0], nums)<br>for i := 1; i < w; i++ {<br>for j := range n - 1<<i + 1 {<br>st[i][j] = op(st[i-1][j], st[i-1][j+1<<(i-1)])<br>}<br>}<br>return sparseTable[T]{st, op}<br>}<br>// [l, r) 左闭右开，下标从 0 开始<br>// 返回 op(nums[l:r])<br>// 时间复杂度 O(1)<br>func (s sparseTable[T]) query(l, r int) T {<br>k := bits.Len(uint(r-l)) - 1<br>return s.op(s.st[k][l], s.st[k][r-1<<k])<br>}<br>// 使用方法举例<br>func main() {<br>nums := []int{3, 1, 4, 1, 5, 9, 2, 6}<br>st := newSparseTable(nums, func(a, b int) int { return max(a, b) })<br>fmt.Println(st.query(0, 5)) // 5<br>fmt.Println(st.query(1, 1)) // 错误：必须保证 l < r<br>}<br>```<br>",
            "src": "",
            "original_src": "",
            "sort": 0,
            "isLeaf": false,
                    ...
                    "nonLeafChild": [
                        {
                            ...
                            "leafChild": [
                                ...
                                },
                                {
                                    ...
                                    "summary": "",
                                    "src": "/sum-of-special-evenly-spaced-elements-in-array/",
                                    "original_src": "https://leetcode.cn/problems/sum-of-special-evenly-spaced-elements-in-array/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
                            ...
                            "leafChild": [
                                {
                                    ...
                                    "summary": "",
                                    "src": "/count-the-number-of-substrings-with-dominant-ones/",
                                    "original_src": "https://leetcode.cn/problems/count-the-number-of-substrings-with-dominant-ones/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": 2556.9955924939,
                                    "leafChild": [],
                                    "nonLeafChild": [],
                                    "isPremium": false,
                                    "last_update": ""
                            ...
                            "leafChild": [
                                {
                                    "title": "2468. 根据限制分割消息",
                                    "summary": "",
                                    "src": "/split-message-based-on-limit/",
                                    "original_src": "https://leetcode.cn/problems/split-message-based-on-limit/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": 2381.6019709166,
                                    "leafChild": [],
                                    "nonLeafChild": [],
                                    "isPremium": false,
                                    "last_update": ""
                                ...
                                },
                                {
                                    "title": "12. 整数转罗马数字",
                                    "summary": "",
                                    "src": "/integer-to-roman/",
                                    "original_src": "https://leetcode.cn/problems/integer-to-roman/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
                                ...
                                },
                                {
                                    "title": "273. 整数转换英文表示",
                                    "summary": "",
                                    "src": "/integer-to-english-words/",
                                    "original_src": "https://leetcode.cn/problems/integer-to-english-words/",
                                    "sort": 0,
                                    "isLeaf": true,
                                    "solution": null,
                                    "score": null,
