            ...
            "nonLeafChild": [
                ...
                },
                {
                    ...
                    "nonLeafChild": [
                        ...
                        {
                            "title": "§2.4 最小化最大值",
                            "summary": "本质是二分答案求最小。二分的 $\\textit{mid}$ 表示上界。<br>好比用一个盖子（上界）去压住最大值，看看能否压住（$\\texttt{check}$ 函数）。<br>",
                            "src": "",
                            "original_src": "",
                            "sort": 0,
                            "isLeaf": false,
